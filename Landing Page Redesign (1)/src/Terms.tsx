...
export default function TermsPage({ onNavigate }: TermsProps) {
  ...
  return (
    <div className="min-h-screen bg-background dark">
      {/* Navigation */}
      <Navigation currentPage="terms" onNavigate={onNavigate} />
        ...
        <div className="container mx-auto max-w-5xl space-y-12">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-foreground">Part A: Binding Agreement</h2>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-foreground">Part B: Licenses and Intellectual Property</h2>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-foreground">Part C: Critical Disclaimers, Liability, and Disputes</h2>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-foreground">Part D: General Provisions</h2>
            </div>
      ...
      {showScrollTop && (
        <motion.button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 w-12 h-12 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center hover:bg-primary/90 transition-colors z-40"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button className="block text-muted-foreground hover:text-primary text-sm transition-colors text-left">Terms of Service</button>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="block text-muted-foreground hover:text-primary text-sm transition-colors">Contact Us</a>
                <a href="#" className="block text-muted-foreground hover:text-primary text-sm transition-colors">FAQ</a>
                <a href="#" className="block text-muted-foreground hover:text-primary text-sm transition-colors">Report Issue</a>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-border text-center text-muted-foreground text-sm">
            ...
            <p className="mt-2 text-xs">Governed by the laws of the Federal Republic of Nigeria.</p>
          </div>
        </div>
      </footer>
    </div>
