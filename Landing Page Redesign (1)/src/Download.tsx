...
export default function DownloadPage({ onNavigate }: DownloadProps) {
  ...
  return (
    <div className="min-h-screen bg-background dark">
      {/* Navigation */}
      <Navigation currentPage="download" onNavigate={onNavigate} />
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1691256676376-357c3aa66c89?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbWFydHBob25lJTIwbW9ja3VwJTIwaGFuZHxlbnwxfHx8fDE3NjIxMTE4MzJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                ...
                >
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1608714783717-618b2de85e39?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpcGhvbmUlMjBob21lJTIwc2NyZWVufGVufDF8fHx8MTc2MjExMTgzMnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
      ...
      {/* Final CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-br from-primary/10 via-background to-background border-y border-border">
