...
export const ChatBox: React.FC<ChatBoxProps> = ({ apiKey }) => {
  ...
  return (
    <div className="flex flex-col w-full mx-auto bg-white rounded-lg h-[calc(100dvh-140px)] max-h-[900px] max-w-full px-2 sm:max-w-2xl sm:h-[700px] sm:max-h-[80vh] sm:px-0">
              ...
              <div
                className={`rounded-xl p-3 sm:p-4 ${
                  message.role === 'user'
                    ...
                    : 'bg-black/20 backdrop-blur-md text-white border border-white/10'
                }`}
              >
